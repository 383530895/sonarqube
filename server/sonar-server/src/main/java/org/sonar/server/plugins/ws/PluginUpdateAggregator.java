...
public class PluginUpdateAggregator {
  ...
  public static class PluginUpdateAggregateBuilder {
    private final Plugin plugin;

    private final List<PluginUpdate> releases = Lists.newArrayListWithExpectedSize(1);
    ...
    public PluginUpdateAggregateBuilder add(PluginUpdate pluginUpdate) {
      ...
      this.releases.add(pluginUpdate);
      return this;
    }
  ...
  public static class PluginUpdateAggregate {
    ...
    private final Collection<PluginUpdate> releases;

    protected PluginUpdateAggregate(PluginUpdateAggregateBuilder builder) {
      this.plugin = builder.plugin;
      this.releases = ImmutableList.copyOf(builder.releases);
    }

    public Plugin getPlugin() {
      return plugin;
    }
    public Collection<PluginUpdate> getReleases() {
      return releases;
    }
